//============================================================================
// PlayterStudent.cs – Playter doll full Kane matrix (torque fixed)          
//----------------------------------------------------------------------------
// 2025-04-27                                                             
// * Shoulder torque includes Iarm only once.
//============================================================================
using System;
...
public partial class PlayterSim : Simulator
{
    ...
    private void RHSFuncPlayter(double[] x, double t, double[] f)
    {
        ...
        double rho2 = rho*rho;
        double Iarm = mA * L * L;        // <-- ONLY declaration of Iarm
        ...
        SetDebugVal(8, omegaFL);      // TestVal_9
